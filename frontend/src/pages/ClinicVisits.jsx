    ...
    */
    ...
    const filteredMedicines = useMemo(() => {
        ...
        return medicines.filter((medicine) => {
            const name = getMedicineName(
                medicine
            ).toLowerCase();

            const unit = getMedicineUnit(
                medicine
            ).toLowerCase();
    ...
    }, [medicines, formData.medicine_id]);
    ...
    */
    ...
    const handleTreatmentChange = (event) => {
        ...
        setFormData((previous) => ({
            ...
            medicine_id:
                value === "Medication"
                    ? previous.medicine_id
                    : "",

            medicine_quantity:
                value === "Medication"
                    ? previous.medicine_quantity
                    : "",
        }));
    ...
    const handleSubmit = async (event) => {
        ...
        if (
            ...
            (!formData.medicine_quantity ||
                Number(formData.medicine_quantity) < 1)
        ) {
            alert(
        ...
        |--------------------------------------------------------------------------
        |
        | For a new visit, the selected medicine must have enough stock.
        |
        | During EDIT, Laravel will perform the final stock check because
        | the old quantity needs to be returned before the new quantity
        | is deducted.
        |
        */
        ...
        if (
            ...
            formData.treatment === "Medication" &&
            selectedMedicine &&
            Number(formData.medicine_quantity) >
                getMedicineStock(selectedMedicine)
        ) {
            alert(
        ...
        const payload = {
            ...
            symptoms:
                formData.symptoms.trim() || null,

            temperature:
                formData.temperature.trim() || null,
        ...
        try {
            ...
            */
            ...
            window.dispatchEvent(
                new Event("medicine-stock-updated")
            );
                            ...
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full rounded-lg border border-gray-300 px-3 py-2.5
                                               focus:border-maroon-600 focus:ring-2 focus:ring-maroon-200
                                               outline-none"
                                    required
                                >
                                    <option value="">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder={
                                            ...
                                            "Medication"
                                                ? "Search medicine..."
                                                : "Select Medication as treatment first"
                                        }
                                        className="w-full rounded-xl border border-[#ead8d3] bg-white py-3 pl-10 pr-3 text-sm outline-none disabled:cursor-not-allowed disabled:bg-[#f8f3f2] focus:border-[#8b1505] focus:ring-4 focus:ring-[#8b1505]/10"
                                    />
                                </div>
                                            ...
                                            0 ? (
                                                ...
                                                filteredMedicines.map(
                                                    (
                                                        ...
                                                        /*
                                                        |----------------------------------------------------------------------
                                                        | During EDIT, allow the currently selected medicine to be opened
                                                        | even if its current inventory is low/zero. Laravel will calculate
                                                        | the final stock after returning the old quantity.
                                                        |----------------------------------------------------------------------
                                                        */
